                                        ...
                                        <div class="table-responsive"
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{\App\Providers\SettingsServiceProvider::getWebsiteFormattedAmount($invoice->data['subtotal'])}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th colspan="2" class="text-right">{{__('Total taxes')}}:</th>
                                                    <th class="text-center">{{ \App\Providers\SettingsServiceProvider::getWebsiteFormattedAmount($invoice->data['taxesTotalAmount'])}}</th>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{\App\Providers\SettingsServiceProvider::getWebsiteFormattedAmount($invoice->data['totalAmount'])}}</th>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
